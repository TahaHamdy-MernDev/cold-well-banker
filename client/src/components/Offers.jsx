  ...
  return (
    <section className="container-xxl section-padding">
      <Link draggable="false" to='/special-offers' className="rounded-2 offer-height " >
        ...
        />
        <div className="mt-2 position-relative d-flex align-items-center justify-content-center justify-content-md-between  h-100 p-4">
          <div className=" d-flex justify-content-start align-items-center gap-3 flex-column flex-md-row">
            ...
            <div className=' d-flex flex-column gap-1 gap-md-2'>
              <h2 className=' fs-1  text-white'> {t('offers.LimitedTime')}<span className=' text-primary-blue'> {t('offers.Offers')} </span></h2>
